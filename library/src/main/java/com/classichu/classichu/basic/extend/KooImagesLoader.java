...
import com.classichu.classichu.basic.lrucache.LruCacheBitmapTool;
import com.classichu.classichu.basic.tool.ImageTool;
import com.classichu.classichu.basic.tool.ReflectTool;
import com.classichu.classichu.basic.tool.RegexTool;
...
public class KooImagesLoader {
    ...
    private Bitmap zoomBitmapFromPath(final String path, final ImageView imageView) {
        ...
        CLog.d("reqWidth:" + reqWidth);
        CLog.d("reqHeight:" + reqHeight);
        // 2、压缩图片
