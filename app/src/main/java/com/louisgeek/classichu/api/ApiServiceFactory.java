...
import com.classichu.classichu.basic.retrofit.RetrofitManager;
...
public class ApiServiceFactory{
    ...
    public GitHubApi getGitHubApi() {
        return createApi("https://api.github.com/",GitHubApi.class);
    }
    ...
    public DouBanApi getDouBanApi() {
        return createApi("https://api.douban.com/v2/",DouBanApi.class);
    }
